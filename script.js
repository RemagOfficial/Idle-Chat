...
function loadChannel(channelId) {
    ...
    if (channelId === 'manual' && currentServer === 'home') {
        ...
        // Off-Topic Channel Unlock (requires bot production maxed)
        const offTopicUnlocked = research.offTopicUnlocked || false;
        const offTopicCost = 25;
        const canAffordOffTopic = !offTopicUnlocked && researchPoints >= offTopicCost && isMaxBot;
                ...
                <div class="research-tree">
                    ...
                    <div class="research-branches ${globalBoostPurchased ? 'unlocked' : ''}">
                        ...
                        <div style="display: flex; flex-direction: column; gap: 20px;">
                            ...
                            <!-- Off-Topic Channel Unlock (under Bot Production) -->
                            <div class="research-node research-node-branch ${!isMaxBot ? 'disabled-node' : (offTopicUnlocked ? 'purchased-node unlocked' : 'unlocked')}" id="research-node-off-topic" style="margin-top: 0;">
                                <div class="research-node-content upgrade-item">
                                    <div class="upgrade-header">
        ...
        if (unlockOffTopicBtn) {
            unlockOffTopicBtn.addEventListener('click', () => {
                const researchPoints = getResearchPoints();
                if (researchPoints >= offTopicCost && isMaxBot && !offTopicUnlocked) {
