...
let gameState = {
    ...
    generator1BotMessages: 0, // Total messages generated by generator1 bots (for pet photo tracking)
...
function getServerPingCount(serverId) {
    ...
    if (serverId === 'generator3') {
        ...
        const research = gameState.research || { globalBoostPurchased: false, manualProduction: 0, botProduction: 0, cascadeProduction: 0, petPhotosUnlocked: false };
        let count = 0;
...
function purchaseGlobalBoost() {
    ...
    if (researchPoints >= cost) {
        ...
        if (totalMessages >= messageCost) {
            ...
            if (!gameState.research) {
                gameState.research = { globalBoostPurchased: false, manualProduction: 0, botProduction: 0, cascadeProduction: 0, petPhotosUnlocked: false };
            }
    ...
    setInterval(() => {
        ...
        if (generator1Production > 0 && isGeneratorUnlocked('generator1')) {
            if (!gameState.generator1BotMessages) {
                gameState.generator1BotMessages = 0;
            }
            ...
            if (gen1WholePart > 0) {
                const previousCount = gameState.generator1BotMessages || 0;
                gameState.generator1BotMessages = previousCount + gen1WholePart;
                ...
                const previousHundreds = Math.floor(previousCount / 100);
                const currentHundreds = Math.floor(gameState.generator1BotMessages / 100);
            ...
            <div class="research-tree-container">
                ...
                <div class="research-tree">
                    ...
                    <div class="research-branches ${globalBoostPurchased ? 'unlocked' : ''}">
                        ...
                        <!-- Bot Production Branch (with nested Pet Photos) -->
        ...
        if (unlockPetPhotosBtn) {
            unlockPetPhotosBtn.addEventListener('click', () => {
                ...
                if (researchPoints >= petPhotosCost && isMaxBot && !petPhotosUnlocked) {
                    ...
                    gameState.messages -= (petPhotosCost * 10000); // Deduct research points (1 RP = 10,000 messages)
                    if (gameState.messages < 0) {
                        gameState.fractionalMessages += gameState.messages;
